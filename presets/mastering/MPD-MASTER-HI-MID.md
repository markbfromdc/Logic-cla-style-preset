# MPD-MASTER-HI-MID — Per-Band Mastering: High-Mid (500 Hz–2 kHz)

**Target:** Mastering-stage high-mid processing — transparent dynamics and tonal control
...
| Slot | Plugin | Purpose |
|------|--------|---------|
| 1 | Linear Phase EQ | Phase-coherent hi-mid EQ |
| 2 | Enveloper | Fixed transient shaping |
| 3 | Compressor (VCA) | Transparent hi-mid dynamics |
| 4 | Exciter | Subtle midrange presence |
...
| 7 | FOCUS | Linear Phase EQ > Parametric Gain (1 kHz) | -3 dB | +3 dB | 0 dB |
| 8 | OUTPUT | Gain > Gain | -8 dB | +4 dB | 0 dB |

**Mastering differences from mixing preset:** Linear Phase EQ, VCA compressor (not FET), reduced ranges, FOCUS at 1 kHz replaces SPACE, no DeEsser.
